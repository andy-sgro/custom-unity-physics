...
public static class Physics
{
	...
	*/
	public static Vector2 CircleBounce(Vector2 velocity, Vector2 thisPos, Vector2 otherPos)
	{
	...
	*			the first argument.
	*/
	public static Vector2 CircleBounce(Vector2 velocity, Direction wallPlacement)
	{
	...
	*			the first two arguments.
	*/
	public static Vector2 CircleBounce(float motionAngle, float speed, float angleToOther)
	{
	...
	*/
	public static float GetAngle(Vector2 thisPos, Vector2 otherPos)
	{
	...
	*/
	public static Vector2 GetVelocity(Vector2 thisPos, Vector2 otherPos, float speed)
	{
	...
	*/
	private static float Roll(float angle)
	{
		angle %= 360;
	...
	*/
	private static float CountRadians(float angle)
	{
	...
	*/
	private static float FlipAngle(float angle)
	{
